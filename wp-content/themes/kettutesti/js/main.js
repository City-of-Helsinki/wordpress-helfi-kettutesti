...
const TopNav_1 = __webpack_require__(/*! ./layouts/topnav/TopNav */ "./layouts/layouts/topnav/TopNav.ts");
const linkcard_1 = __webpack_require__(/*! ./layouts/linkcard/linkcard */ "./layouts/layouts/linkcard/linkcard.ts");
const HeroMedia_1 = __webpack_require__(/*! ./layouts/heromedia/HeroMedia */ "./layouts/layouts/heromedia/HeroMedia.ts");
const HeroResultDisplay_1 = __webpack_require__(/*! ./layouts/heroresultdisplay/HeroResultDisplay */ "./layouts/layouts/heroresultdisplay/HeroResultDisplay.ts");
const foxgallary_1 = __webpack_require__(/*! ./layouts/foxgallary/foxgallary */ "./layouts/layouts/foxgallary/foxgallary.ts");
const BookDisplay_1 = __webpack_require__(/*! ./layouts/bookdisplay/BookDisplay */ "./layouts/layouts/bookdisplay/BookDisplay.ts");
const ImageDisplay_1 = __webpack_require__(/*! ./layouts/imagedisplay/ImageDisplay */ "./layouts/layouts/imagedisplay/ImageDisplay.ts");
const HeroMediaQuiz_1 = __webpack_require__(/*! ./layouts/heromediaquiz/HeroMediaQuiz */ "./layouts/layouts/heromediaquiz/HeroMediaQuiz.ts");
...
class Layouts {
    constructor() {
        ...
        $(".topnav").each(function (index, element) {
            self.layouts.push(new TopNav_1.TopNav($(element)));
        });
        $(".linkcard").each(function (index, element) {
            self.layouts.push(new linkcard_1.linkcard($(element)));
        });
        $(".heromedia").each(function (index, element) {
            self.layouts.push(new HeroMedia_1.HeroMedia($(element)));
        });
        $(".heroresultdisplay").each(function (index, element) {
            self.layouts.push(new HeroResultDisplay_1.HeroResultDisplay($(element)));
        });
        $(".foxgallary").each(function (index, element) {
            self.layouts.push(new foxgallary_1.foxgallary($(element)));
        });
        $(".bookdisplay").each(function (index, element) {
            self.layouts.push(new BookDisplay_1.BookDisplay($(element)));
        });
        $(".imagedisplay").each(function (index, element) {
            self.layouts.push(new ImageDisplay_1.ImageDisplay($(element)));
        });
        $(".heromediaquiz").each(function (index, element) {
            self.layouts.push(new HeroMediaQuiz_1.HeroMediaQuiz($(element)));
        });
...
/***/ "./layouts/layouts/bookdisplay/BookDisplay.ts":
/*!****************************************************!*\
  !*** ./layouts/layouts/bookdisplay/BookDisplay.ts ***!
  \****************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.BookDisplay = void 0;
const Layout_1 = __webpack_require__(/*! ../../../src/ts/layouts/Layout */ "./src/ts/layouts/Layout.ts");
class BookDisplay extends Layout_1.Layout {
    constructor($elem) {
        super($elem);
    }
}
...
/***/ "./layouts/layouts/foxgallary/foxgallary.ts":
/*!**************************************************!*\
  !*** ./layouts/layouts/foxgallary/foxgallary.ts ***!
  \**************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.foxgallary = void 0;
const Layout_1 = __webpack_require__(/*! ../../../src/ts/layouts/Layout */ "./src/ts/layouts/Layout.ts");
class foxgallary extends Layout_1.Layout {
    constructor($elem) {
        super($elem);
    }
}
exports.foxgallary = foxgallary;
...
/***/ "./layouts/layouts/heromedia/HeroMedia.ts":
/*!************************************************!*\
  !*** ./layouts/layouts/heromedia/HeroMedia.ts ***!
  \************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.HeroMedia = void 0;
const Layout_1 = __webpack_require__(/*! ../../../src/ts/layouts/Layout */ "./src/ts/layouts/Layout.ts");
class HeroMedia extends Layout_1.Layout {
    constructor($elem) {
        super($elem);
    }
}
...
/***/ "./layouts/layouts/heromediaquiz/HeroMediaQuiz.ts":
/*!********************************************************!*\
  !*** ./layouts/layouts/heromediaquiz/HeroMediaQuiz.ts ***!
  \********************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.HeroMediaQuiz = void 0;
const Layout_1 = __webpack_require__(/*! ../../../src/ts/layouts/Layout */ "./src/ts/layouts/Layout.ts");
class HeroMediaQuiz extends Layout_1.Layout {
    constructor($elem) {
        super($elem);
    ...
    CalculateTotal(ListOfScores) {
        return ListOfScores.reduce((previousValue, currentValue) => {
            /* @ts-ignore */
...
exports.HeroMediaQuiz = HeroMediaQuiz;


/***/ }),

/***/ "./layouts/layouts/heroresultdisplay/HeroResultDisplay.ts":
/*!****************************************************************!*\
  !*** ./layouts/layouts/heroresultdisplay/HeroResultDisplay.ts ***!
  \****************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.HeroResultDisplay = void 0;
const Layout_1 = __webpack_require__(/*! ../../../src/ts/layouts/Layout */ "./src/ts/layouts/Layout.ts");
class HeroResultDisplay extends Layout_1.Layout {
    // private layouts:Array<Layout>;
    // private resultTitle: HTMLElement;
    // private subTitle: HTMLElement;
    // private resDes: HTMLElement;
    // private imageData:any;
    // private foxInfo:any;
    // private imageDisplayCont:HTMLElement;
    // private titleToDisplay:string;
    // private imageToDisplay:string;
    // private subtitleToDisplay:string;
    // private descriptionToDisplay: string;
    constructor($elem) {
        super($elem);
        // let result= JSON.parse(localStorage.getItem("result"));
        // this.resultTitle=document.querySelector("#resulttitle");
        // this.subTitle= document.querySelector("#resultsubs");
        // this.resDes= document.querySelector("#resultdes");
        // this.imageDisplayCont= document.querySelector("#imgdisplay");
        // this.imageData= window.myDataImage1;
        // this.foxInfo=window.myDataInfo1;
        // console.log(this.foxInfo);
        // 	switch (result.name) {
        // 		case "kokki":
        // 			this.titleToDisplay=this.foxInfo[0].result.title; 
        // 			this.imageToDisplay=this.imageData[0].url;
        // 			this.subtitleToDisplay=this.foxInfo[0].result.subtitle;
        // 			this.descriptionToDisplay=this.foxInfo[0].result.description;
        // 			break;
        // 		case "retki":
        // 			this.titleToDisplay=this.foxInfo[1].result.title; 
        // 			this.imageToDisplay=this.imageData[2].url;
        // 			this.subtitleToDisplay=this.foxInfo[1].result.subtitle;
        // 			this.descriptionToDisplay=this.foxInfo[1].result.description;
        // 			break;
        // 		case "taitava":
        // 			this.titleToDisplay=this.foxInfo[2].result.title; 
        // 			this.imageToDisplay=this.imageData[1].url;
        // 			this.subtitleToDisplay=this.foxInfo[2].result.subtitle;
        // 			this.descriptionToDisplay=this.foxInfo[2].result.description;
        // 			break;
        // 		case "keksija":
        // 			this.titleToDisplay=this.foxInfo[3].result.title; 
        // 			this.imageToDisplay=this.imageData[6].url;
        // 			this.subtitleToDisplay=this.foxInfo[3].result.subtitle;
        // 			this.descriptionToDisplay=this.foxInfo[3].result.description;
        // 			break;
        // 		case "taitelija":
        // 			this.titleToDisplay=this.foxInfo[4].result.title; 
        // 			this.imageToDisplay=this.imageData[3].url;
        // 			this.subtitleToDisplay=this.foxInfo[4].result.subtitle;
        // 			this.descriptionToDisplay=this.foxInfo[4].result.description;
        // 			break;
        // 		case "tarina":
        // 			this.titleToDisplay=this.foxInfo[5].result.title; 
        // 			this.imageToDisplay=this.imageData[5].url;
        // 			this.subtitleToDisplay=this.foxInfo[5].result.subtitle;
        // 			this.descriptionToDisplay=this.foxInfo[5].result.description;
        // 			break;
        // 		case "viisas":
        // 			this.titleToDisplay=this.foxInfo[6].result.title; 
        // 			this.imageToDisplay=this.imageData[4].url;
        // 			this.subtitleToDisplay=this.foxInfo[6].result.subtitle;
        // 			this.descriptionToDisplay=this.foxInfo[6].result.description;
        // 			break;
        // 	}
        // 	this.resultTitle.textContent=`${this.titleToDisplay}`;
        // 	this.subTitle.textContent=this.subtitleToDisplay;
        // 	this.resDes.textContent= this.descriptionToDisplay;
        // 	let image=`<img src=${this.imageToDisplay} alt=${result.name}></img>`;
        // 	this.imageDisplayCont.innerHTML=image;
        // }
    }
}
exports.HeroResultDisplay = HeroResultDisplay;
...
/***/ "./layouts/layouts/imagedisplay/ImageDisplay.ts":
/*!******************************************************!*\
  !*** ./layouts/layouts/imagedisplay/ImageDisplay.ts ***!
  \******************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.ImageDisplay = void 0;
const Layout_1 = __webpack_require__(/*! ../../../src/ts/layouts/Layout */ "./src/ts/layouts/Layout.ts");
class ImageDisplay extends Layout_1.Layout {
    constructor($elem) {
        super($elem);
    }
}
...
/***/ "./layouts/layouts/linkcard/linkcard.ts":
/*!**********************************************!*\
  !*** ./layouts/layouts/linkcard/linkcard.ts ***!
  \**********************************************/
/*! no static exports found */
...
const Layout_1 = __webpack_require__(/*! ../../../src/ts/layouts/Layout */ "./src/ts/layouts/Layout.ts");
class linkcard extends Layout_1.Layout {
    constructor($elem) {
        super($elem);
    }
}
...
/***/ "./layouts/layouts/topnav/TopNav.ts":
/*!******************************************!*\
  !*** ./layouts/layouts/topnav/TopNav.ts ***!
  \******************************************/
/*! no static exports found */
...
const Layout_1 = __webpack_require__(/*! ../../../src/ts/layouts/Layout */ "./src/ts/layouts/Layout.ts");
class TopNav extends Layout_1.Layout {
